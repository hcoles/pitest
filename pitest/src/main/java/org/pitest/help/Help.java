...
public enum Help {
  ...
  NO_MUTATIONS_FOUND(
      ...
      "Unsupported JUnit version %s. PIT requires JUnit 4.6 or above."), FAILING_TESTS(
      "All tests did not pass without mutation when calculating line coverage. Mutation testing requires a green suite."), NO_JUNIT(
