...
/**
 * Mutator for non-void methods that have a parameter that matches
 * the return type: it replaces the result of the method call with a
 * parameter. E. g. the method call
 *
 * <pre>
