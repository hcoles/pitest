...
public enum PreDec implements MethodMutatorFactory {

    PRE_DEC;

    public MethodVisitor create(final MutationContext context, final MethodInfo methodInfo,
            final MethodVisitor methodVisitor) {
        return new PreDecVisitor(this, context, methodInfo, methodVisitor);
    }
...
class PreDecVisitor extends MethodVisitor {

    private final MethodMutatorFactory factory;
    private final MutationContext context;
    private final MethodInfo info;

    PreDecVisitor(final MethodMutatorFactory factory, final MutationContext context, final MethodInfo info,
    ...
    public void visitVarInsn(int opcode, int var) {
        switch (opcode) {
        case Opcodes.ILOAD:
            if (this.shouldMutate("Pre Decrement Mutator")) {
