...
public class RemoteContainerCacheTest {
  ...
  @Test
  public void shouldReturnsNoCachedContainerIfRunNotPresent() {
    assertEquals(Option.none(),
        this.testee.getCachedContainer(this.runDetailsOne));
  }

  @Test
  public void shouldReturnTheContainerAssignedToARun() {
    ...
    assertEquals(Option.some(expected),
        this.testee.getCachedContainer(this.runDetailsTwo));
  ...
  private DefaultPITClassloader getClassLoader() {
    return new DefaultPITClassloader(null,
