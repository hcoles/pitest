...
public class RunDetailsTest {
  ...
  public void shouldKeepEqualsContract() {
    EqualsVerifier
        .forClass(RunDetails.class)
        .withPrefabValues(InetSocketAddress.class, new InetSocketAddress(0),
  ...
  @Test
  public void shouldGenerateAnIdentifierWithOnlyAlphaNumericCharacters() {
