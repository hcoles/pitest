...
public class ParameterizedInstantiationStrategyTest {
  ...
  @Test
  public void canInstantiateShouldReturnFalseForClassNotAnnotatedWithRunWith() {
    class UnAnnotated {
  ...
  @Test
  public void canInstantiateShouldReturnFalseForClassRunWithRunnerOtherThanParametized() {
    @RunWith(Suite.class)
    class Annotated {
  ...
  @Test
  public void canInstantiateShouldReturnTrueForClassRunWithParameterized() {
  ...
  @Test
  public void canInstantiateShouldReturnTrueForClassRunWithPitRunnerWithParametersMethod() {
    assertTrue(this.testee.canInstantiate(AnnotatedWithParametersMethod.class));
  }

  @Test
  public void canInstantiateShouldReturnFalseForClassRunWithPitRunnerWithoutParametersMethod() {
    @RunWith(PITJUnitRunner.class)
    class Annotated {
  ...
  @Test
  public void shouldReturnTestStepForEachParameter() {
