...
public class NamedTestSingleStringConstructorInstantiationStrategyTest {
  ...
  @Test
  public void shouldReturnFalseIfSingleStringConstructorNotPresent() {
  ...
  @Test
  public void shouldReturnTrueIfSingleStringConstructorPresent() {
    assertTrue(this.testee.canInstantiate(StringConstructor.class));
  }

  @Test
  public void shouldCreateSingleNameStringConstructorInstantiateStepTest() {
