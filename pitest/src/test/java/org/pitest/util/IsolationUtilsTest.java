...
public class IsolationUtilsTest {
  ...
  public void shouldRecogniseClassFromBootClassLoaderAsFromBootLoader() {
    ...
    assertFalse(testee.fromDifferentLoader(Integer.class, IsolationUtils.bootClassLoader()));
  }
  
  @Test
  public void shouldRecogniseClassFromChildOfBootClassLoaderAsFromBootLoader() {
    ClassLoaderDetectionStrategy testee = IsolationUtils.loaderDetectionStrategy();
    assertFalse(testee.fromDifferentLoader(IsolationUtilsTest.class, IsolationUtils.bootClassLoader()));
  }
  
  @Test
  public void shouldRecogniseClassFromChildOfChildOfBootClassLoaderAsFromCompatibleLoader() throws ClassNotFoundException {
    ClassLoaderDetectionStrategy testee = IsolationUtils.loaderDetectionStrategy();
    DefaultPITClassloader parent = new DefaultPITClassloader(new ClassPath(), IsolationUtils.bootClassLoader());
    DefaultPITClassloader loader = new DefaultPITClassloader(new ClassPath(), parent);
  ...
  public void shouldNotRecogniseClassFromSiblingLoaderAsFromCompatibleLoader() throws ClassNotFoundException {
    ClassLoaderDetectionStrategy testee = IsolationUtils.loaderDetectionStrategy();
    DefaultPITClassloader siblingLoader = new DefaultPITClassloader(new ClassPath(), IsolationUtils.bootClassLoader());
    Class<?> foreign = siblingLoader.loadClass(IsolationUtilsTest.class.getName());
    assertTrue(testee.fromDifferentLoader(foreign, new DefaultPITClassloader(new ClassPath(), IsolationUtils.bootClassLoader())));
  }
}
