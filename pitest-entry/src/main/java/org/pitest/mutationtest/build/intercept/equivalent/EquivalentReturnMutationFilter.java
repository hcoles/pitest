...
/**
 * Tightly coupled to the PrimitiveReturnsMutator and EmptyReturnsMutator
...
class HardCodedTrueEquivalentFilter implements MutationInterceptor {   
  ...
  static {
     MUTATOR_IDS.add(TrueReturnsMutator.TRUE_RETURNS_MUTATOR.getGloballyUniqueId());
  }
...
class PrimitiveEquivalentFilter implements MutationInterceptor {
  ...
  static {
    ...
    MUTATOR_IDS.add(PrimitiveReturnsMutator.PRIMITIVE_RETURNS_MUTATOR.getGloballyUniqueId());
    MUTATOR_IDS.add(FalseReturnsMutator.FALSE_RETURNS_MUTATOR.getGloballyUniqueId());
  }
...
class EmptyReturnsFilter implements MutationInterceptor {
  ...
  static {
    ...
    MUTATOR_IDS.add(EmptyReturnsMutator.EMPTY_RETURNS_MUTATOR.getGloballyUniqueId());
    MUTATOR_IDS.add(FalseReturnsMutator.FALSE_RETURNS_MUTATOR.getGloballyUniqueId());
  }
...
class NullReturnsFilter implements MutationInterceptor {
  ...
  private static final String MUTATOR_ID = NullReturnsMutator.NULL_RETURNS_MUTATOR
      .getGloballyUniqueId();
