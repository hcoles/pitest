...
public class PitReportMojoTest {
	...
	@Captor private ArgumentCaptor<ReportGenerationContext> contextCaptor;
	
	@Mock private Log log;
	@Mock private File reportsDirectory;
	@Mock private ReportGenerationManager reportGenerationManager;
	@Mock private Sink sink;
	
	@InjectMocks private PitReportMojo fixture;
	...
	public void testGenerateReport() throws Exception {
		...
		verify(this.reportGenerationManager).generateSiteReport(contextCaptor.capture());
		...
		assertThat(actualContext.getReportsDataDirectory(), sameInstance(this.reportsDirectory));
		assertThat(actualContext.getSink(), sameInstance(this.sink));
		assertThat(actualContext.getSiteDirectory().getPath(), is("abspath" + File.separator + "pit-reports"));
	}
	
	private void setupMocks(boolean reportsDirectoryExists, boolean reportsDirectoryReadable, boolean reportsDirectoryIsDirectory) {
