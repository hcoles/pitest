...
public class PitReportMojo extends AbstractMavenReport {
   ...
   * skipped.
   * 
   * @parameter default-value="false" expression="${pit.report.skip}"
   */
   ...
   * 
   * @parameter default-value="PIT Test Report" expression="${pit.report.name}"
   */
   ...
   * 
   * @parameter default-value="pit-reports" expression="${pit.report.outputdir}"
   */
