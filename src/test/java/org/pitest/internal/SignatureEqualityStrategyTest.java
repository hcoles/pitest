...
public class SignatureEqualityStrategyTest {
  ...
  @Test
  public void testDifferentlyNamedMethodsConsideredNotEqual() {
    assertFalse(this.testee.isEqual(createTestMethod("foo"),
        createTestMethod("bar")));
  }

  @Test
  public void testSameMethodConsideredNotEqual() {
    assertTrue(this.testee.isEqual(createTestMethod("foo"),
        createTestMethod("foo")));
  }

  @Test
  public void testMethodsWithSameNameButDifferentSignaturesConsideredNotEqual() {
