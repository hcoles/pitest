...
public class CodeCoverageStore {
  ...
  public static void init(final InvokeQueue invokeQueue,
      final InvokeStatistics invokeStatistics) {
  ...
  public static void visitMethod(final int classId, final int methodId) {
  ...
  public static int registerMethod(final int classId, final String methodName,
