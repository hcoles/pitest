...
import org.pitest.mutationtest.report.html.HtmlReportPlugin;
...
public class PluginFilterTest {
  ...
  public void shouldExcludeHtmlReportPlugin() {
    ...
    String pluginLocation = HtmlReportPlugin.class.getProtectionDomain().getCodeSource().getLocation().getFile();
